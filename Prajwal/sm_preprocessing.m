...
PP_CAT = readmatrix('.\Catalogues\PreProcessed_Catalogue.csv'); % Read - Preprocessed catalogue (which contains the star pairs)
...
writematrix(REF_CAT, '.\Catalogues\Reference_Catalogue.csv');
